...
const isDirty = computed(() => displayName.value.trim() !== (profile.value?.display_name ?? ''));
...
async function purgeUserPhotos(userId: string) {
    ...
    console.warn('[purgeUserPhotos] hit iteration cap; some photos may remain in storage');
}
    ...
    <section class="mx-auto max-w-xl px-4 py-8">
        ...
        <section class="mt-10 rounded-xl border border-red-200 bg-red-50 p-5">
            ...
            <p class="mt-1 text-sm text-red-800">
                ...
                sale, every route you've planned, and every conversation you've had. This can't be
                undone.
            </p>
            ...
            <div v-else class="mt-4 space-y-3">
                ...
                />
                <p v-if="deleteError" class="rounded-lg bg-red-100 px-3 py-2 text-sm text-red-800">
                    {{ deleteError }}
                </p>
